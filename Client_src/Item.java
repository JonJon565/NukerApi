...
public class Item {
	...
	//Nukerapi start
	protected boolean is3x3x1 = false;
	protected boolean is3x3x3 = false;
	protected boolean is5x4x1 = false;
	protected boolean iscustomnapi = false;
	protected Class<?> itemClass = napi_default.class;
	//Nukerapi end
	...
	//nukerapi start
	public Item set3x3x3() {
		this.is3x3x3 = true;
		return this;
	}
	public Item set3x3x1() {
		this.is3x3x1 = true;
		return this;
	}
	public Item set5x4x1() {
		this.is5x4x1 = true;
		return this;
	}
    public Item setClass(Class<?> clazz) {
    	this.iscustomnapi = true;
        this.itemClass = clazz;
        return this;
    }
	public Class<?> getNapiClass() {
